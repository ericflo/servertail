...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ServerTail.port'
        db.add_column('tail_servertail', 'port', self.gf('django.db.models.fields.IntegerField')(default=22), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ServerTail.port'
        db.delete_column('tail_servertail', 'port')
